...
1) What values of n do we see any improvement in runtime using the parallel approach compared to the serial approach?
    - According to the report below, the parallel algorithms do not perform better than the sequential algorithms=.
===============================
= RUNTIME REPORT (in seconds) =
===============================
n       | Sequential Generic    | Sequential Recursive  | Sequential Strassen's | Parallel Recursive    | Parallel Strassen's   |
2       | 0.000002              | 0.000007              | 0.000013              | 0.000021              | 0.000025              |
52      | 0.009348              | 0.031895              | 0.134984              | 0.034722              | 0.133055              |
102     | 0.083191              | 0.238812              | 0.930419              | 0.278497              | 0.970847              |
...
def recursive_matrix_multiplication_parallel(matrixA, matrixB, matrixC, n,
   ...
   # Base case
    ...
    # Temporary matrix D of size n x n (pseudocode says size n x n)
...
def perform_and_compare_multiplications(n):
    ...
    string_results = f"{n}\t| {duration1:,.6f}\t\t| {duration2:,.6f}\t\t| {duration3:,.6f}\t\t| {duration4:,.6f}\t\t| {duration5:,.6f}\t\t|"    
...
def main():    
    ...
    print("===============================")
    string_header = "n\t| Sequential Generic\t| Sequential Recursive\t| Sequential Strassen's\t| Parallel Recursive\t| Parallel Strassen's   |"
    print(string_header)
